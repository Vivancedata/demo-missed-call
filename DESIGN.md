...
description: >
  ...
  waveform mark, a paste box, and a result that shows its own uncertainty.
...
# Design System: Missed-Call Demo
...
three unrelated pages. This one is `--chart-1`, the brand green.
...
### Secondary
- **waveform Mark** (`hsl(152 45% 50%)`): the page mark, and nothing else.
...
breaks this**: the hint under the disabled action — "Paste a transcript, or take
